  ...
  <div
    ...
    <div class="toolbar">
      ...
      <el-button
        v-if="parseTool"
        size="mini"
        @click="parseEditor()">Parse</el-button>
      <el-button
        v-if="fullscreenTool"
        size="mini"
...
export default {
  ...
  mounted() {
    ...
    // Automatically scrolling cursor into view after
    // selection change this will be disabled in the next
